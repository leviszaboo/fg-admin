  ...
  return (
    <div className="border-2 border-brown rounded-lg h-40 flex flex-column items-center content-center justify-center text-center">
      ...
      <div className="absolute top-0 right-0 pt-2 pr-2 z-50">
        <DeleteParagraphDialog id={paragraph.id} dialogOpen={deleteDialogOpen} setDialogOpen={setDeleteDialogOpen}/>
        <UpdateParagraphDialog id={paragraph.id} dialogOpen={updateDialogOpen} setDialogOpen={setUpdateDialogOpen} />
        <ParagraphOptions
          open={menuOpen} 
          setOpen={setMenuOpen} 
